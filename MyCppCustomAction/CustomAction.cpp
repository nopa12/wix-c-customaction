...
// to disable mangling around exports
#ifdef __cplusplus
extern "C"
{
#endif
...
/// </summary>
__declspec(dllexport) UINT __stdcall MyImmediateCustomAction(MSIHANDLE hInstall)
{
  HRESULT hr = S_OK;
...
/// </summary>
__declspec(dllexport) UINT __stdcall MyDeferredCustomAction(MSIHANDLE hInstall)
{
  HRESULT hr = S_OK;
  UINT er = ERROR_SUCCESS;
